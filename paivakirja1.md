...
| git init | perustaa Git-repositorion |
| git status | kertoo tilanteen|
| echo "haluttu teksti" > tiedosto | Luo tietyn nimisen tiedoston halutulla sisällöllä. |
| git add | lisätään tiedosto seuraavaa talletusta varten|
| git commit | tekee talletuksen |
| git mv vanhatiedosto uusitiedosto | vaihtaa tiedoston nimen |
