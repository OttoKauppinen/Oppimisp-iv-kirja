...
-Pysyt helposti ajan tasalla uusimmista versioista.

-Voit poistaa tiedostoja ja peruuttaa vahinko poistot.

-Virheiden jäljittäminen on helpompaa.


__Mitä hyötyä voisi olla versionhallinnasta, jos projektissa on useita kehittäjiä?__

-Pysytään helposti ajan tasalla siitä mitä on tehty ja kuka on tehnyt muutoksia. 
...
-Käytetään GitHub repositoriota.

-Kaikilla on omat työskentely haarat.
...
-Opintojakso oli kyllä super mielenkiintoinen, kiitos siitä. Digipuoleen suuntautuvalle kurssi oli ihan tarpeeksi haastava, mutta mukava suorittaa.
